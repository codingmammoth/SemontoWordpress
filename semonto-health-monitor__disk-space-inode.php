                ...
                <div class="semonto-health-monitor__switch-container">
                    ...
                    <div class="switch-option">
                        <label class="semonto-health-monitor__test-switch">
                            ...
                            value="1" <?php checked(1, get_option('semonto_enable_disk_space_inode_test', true)); ?>
                            />
            ...
            <?php foreach ($disks as $disk_name => $disk_config ): ?>
                <div class="">
                    <div class="semonto-health-monitor__test">
                        <div class="semonto-health-monitor__switch-container">
                            <label
                                for="semonto_config_disk_space_inode[<?php echo esc_html($disk_name); ?>][enabled]"
                                class="semonto-health-monitor__switch-label"
                            ...
                            <div class="switch-option">
                                <label class="semonto-health-monitor__test-switch">
                                    <input
                                        type="checkbox"
                                        name="semonto_config_disk_space_inode[<?php echo esc_html($disk_name); ?>][enabled]"
                                        id="semonto_config_disk_space_inode[<?php echo esc_html($disk_name); ?>][enabled]"
                        ...
                        <input
                            ...
                            min="0"
                            max="100"
                            name="semonto_config_disk_space_inode[<?php echo esc_html($disk_name); ?>][warning_percentage_threshold]"
                        ...
                        <input
                            ...
                            min="0"
                            max="100"
                            name="semonto_config_disk_space_inode[<?php echo esc_html($disk_name); ?>][error_percentage_threshold]"
