    ...
    <div class="input-fields-text">
        ...
        <div class="switch-option">
            <label class="switch">
                <input
                type="checkbox"
                name="semonto_disk_space_enable"
                value="1" <?php checked(1, get_option('semonto_disk_space_enable')); ?>
                />
                ...
                <p class="title-test"><?php echo $disk_name; ?>:</p>
                    <div class="switch-option">
                        <label class="switch">
                            <input
                                type="checkbox"
                                name="semonto_disk_space_config[<?php echo $disk_name; ?>][enabled]"
                    ...
                    <input
                        ...
                        min="1"
                        max="100"
                        name="semonto_disk_space_config[<?php echo $disk_name; ?>][warning_percentage_threshold]"
                    ...
                    <input
                        ...
                        min="1"
                        max="100"
                        name="semonto_disk_space_config[<?php echo $disk_name; ?>][error_percentage_threshold]"
